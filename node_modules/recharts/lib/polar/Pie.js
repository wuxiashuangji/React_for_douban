    ...
    value: function renderLabels(sectors) {
      ...
      var labels = sectors.map(function (entry, i) {
        ...
        return _react2.default.createElement(
          ...
          _this2.renderLabelItem(label, labelProps, (0, _ChartUtils.getValueByDataKey)(entry, dataKey))
        );
      });
      ...
      return _react2.default.createElement(
        ...
        function (_ref3) {
          ...
          sectors.forEach(function (entry, index) {
            ...
            if (prev) {
              var angleIp = (0, _d3Interpolate.interpolateNumber)(prev.endAngle - prev.startAngle, entry.endAngle - entry.startAngle);
              ...
              var interpolatorAngle = (0, _d3Interpolate.interpolateNumber)(0, endAngle - startAngle);
